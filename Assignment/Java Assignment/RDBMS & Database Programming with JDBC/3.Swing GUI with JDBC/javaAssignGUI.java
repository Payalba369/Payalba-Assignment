...
public class javaAssignGUI extends JFrame {
    // DB connection 
    ...
    public javaAssignGUI() {
        super("users1 Manager (CRUD Demo)");
    ...
    private void insertUser() {
        ...
        if (fname.isEmpty() || lname.isEmpty() || email.isEmpty()) {
            showError("All fields except ID are required!");
            return;
        }
    ...
    private void updateUser() {
        ...
        if (idText.isEmpty()) {
            showError("ID required for update!");
            return;
        }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new javaAssignGUI().setVisible(true));
    }
}
